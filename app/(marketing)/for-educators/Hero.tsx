    ...
    return (
        <section className="px-6 py-24 text-center max-w-5xl mx-auto">
            ...
            <div className="flex justify-center gap-4">
                <Button size="lg" variant="primary" className="cursor-pointer">Start Free Trial</Button>
                <Button size="lg" variant="secondary" className="cursor-pointer">Request School Demo</Button>
            </div>
        </section>
    );
}